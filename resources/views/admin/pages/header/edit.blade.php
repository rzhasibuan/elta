        ...
        <form action="{{route('admin.header.update',$data->id)}}" method="post" enctype="multipart/form-data">
            ...
            <div class="box-body">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="Bigtitle" placeholder="please type big title" name="bigTitle" value="{{$data->bigtitle}}">
                    <div class="has-error">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="linkButton" placeholder="please type link button" name="linkButton" value="{{$data->linkButton}}">
                    <div class="has-error">
                    <span class="help-block">
